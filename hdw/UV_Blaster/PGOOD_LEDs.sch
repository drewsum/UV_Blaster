...
AR Path="/5E9E1DF7/5CB89777" Ref="C901"  Part="1" 
F 0 "C901" H 1485 2280 50  0000 L CNN
...
AR Path="/5E9E1DF7/5CB89785" Ref="D901"  Part="1" 
F 0 "D901" V 3589 2483 50  0000 R CNN
F 1 "Green" V 3498 2483 50  0000 R CNN
F 2 "LEDs:LED_0402" H 3550 2600 50  0001 C CNN
F 3 "~" H 3550 2600 50  0001 C CNN
F 4 "754-1815-1-ND" H -1610 -3720 50  0001 C CNN "Digi-Key PN"
	1    3550 2600
	0    -1   -1   0   
$EndComp
Wire Wire Line
...
AR Path="/5E9E1DF7/5CB89791" Ref="R901"  Part="1" 
F 0 "R901" H 3490 2300 50  0000 R CNN
...
F 7 "P1.00KLCT-ND" H 3850 2700 60  0001 C CNN "Digi-Key PN"
	1    3550 2300
	-1   0    0    -1  
$EndComp
$Comp
...
AR Path="/5E9E1DF7/5CB897A9" Ref="#PWR0907"  Part="1" 
F 0 "#PWR0907" H 2980 2720 50  0001 C CNN
...
AR Path="/5E9E1DF7/5CB897AF" Ref="#PWR0904"  Part="1" 
F 0 "#PWR0904" H 2570 2080 50  0001 C CNN
...
AR Path="/5E9E1DF7/5E16D9D0" Ref="#PWR0903"  Part="1" 
F 0 "#PWR0903" H 1990 2000 50  0001 C CNN
...
AR Path="/5E9E1DF7/5E170744" Ref="#PWR0902"  Part="1" 
F 0 "#PWR0902" H 1460 2080 50  0001 C CNN
...
U 1 1 5E170DFC
P 1460 1870
F 0 "#PWR0901" H 1460 1720 50  0001 C CNN
...
AR Path="/5E9E1DF7/5E1829A4" Ref="C903"  Part="1" 
F 0 "C903" H 2895 3780 50  0000 L CNN
...
AR Path="/5E9E1DF7/5E1829AF" Ref="D902"  Part="1" 
F 0 "D902" V 3589 3983 50  0000 R CNN
F 1 "Green" V 3498 3983 50  0000 R CNN
F 2 "LEDs:LED_0402" H 3550 4100 50  0001 C CNN
F 3 "~" H 3550 4100 50  0001 C CNN
F 4 "754-1815-1-ND" H -1610 -2220 50  0001 C CNN "Digi-Key PN"
	1    3550 4100
	0    -1   -1   0   
$EndComp
Wire Wire Line
...
AR Path="/5E9E1DF7/5E1829BF" Ref="R902"  Part="1" 
F 0 "R902" H 3490 3800 50  0000 R CNN
...
F 7 "P1.00KLCT-ND" H 3850 4200 60  0001 C CNN "Digi-Key PN"
	1    3550 3800
	-1   0    0    -1  
$EndComp
$Comp
...
AR Path="/5E9E1DF7/5E1829E7" Ref="#PWR0909"  Part="1" 
F 0 "#PWR0909" H 2980 4220 50  0001 C CNN
...
AR Path="/5E9E1DF7/5E1829F1" Ref="#PWR0906"  Part="1" 
F 0 "#PWR0906" H 2870 3580 50  0001 C CNN
...
AR Path="/5E9E1DF7/5E1D006C" Ref="C904"  Part="1" 
F 0 "C904" H 4895 2280 50  0000 L CNN
...
AR Path="/5E9E1DF7/5E1D0077" Ref="D903"  Part="1" 
F 0 "D903" V 5589 2483 50  0000 R CNN
F 1 "Green" V 5498 2483 50  0000 R CNN
F 2 "LEDs:LED_0402" H 5550 2600 50  0001 C CNN
F 3 "~" H 5550 2600 50  0001 C CNN
F 4 "754-1815-1-ND" H 390 -3720 50  0001 C CNN "Digi-Key PN"
	1    5550 2600
	0    -1   -1   0   
$EndComp
Wire Wire Line
...
AR Path="/5E9E1DF7/5E1D0087" Ref="R903"  Part="1" 
F 0 "R903" H 5490 2300 50  0000 R CNN
...
F 7 "P1.00KLCT-ND" H 5850 2700 60  0001 C CNN "Digi-Key PN"
	1    5550 2300
	-1   0    0    -1  
$EndComp
...
AR Path="/5E9E1DF7/5E9CB67B" Ref="#PWR0914"  Part="1" 
F 0 "#PWR0914" H 4980 2720 50  0001 C CNN
...
AR Path="/5E9E1DF7/5E9CCE69" Ref="#PWR0912"  Part="1" 
F 0 "#PWR0912" H 4870 2080 50  0001 C CNN
...
U 1 1 5E9DF04D
P 2980 2870
F 0 "U902" H 3080 3020 50  0000 L CNN
...
U 1 1 5E9E1221
P 4980 2870
F 0 "U904" H 5080 3020 50  0000 L CNN
...
U 1 1 5E9E1A18
P 2980 4370
F 0 "U903" H 3080 4520 50  0000 L CNN
...
U 1 1 5E9FA9C1
P 2570 2180
F 0 "C902" H 2595 2280 50  0000 L CNN
...
F 7 "490-14306-1-ND" H 2995 2680 60  0001 C CNN "Digi-Key PN"
	1    2570 2180
	1    0    0    -1  
$EndComp
$Comp
L Regulator_Linear:TPS71550__SC70 U901
U 1 1 5EA0E43D
P 1990 1950
F 0 "U901" H 1840 2075 50  0000 C CNN
...
F 4 "296-15046-1-ND" H 1990 1950 50  0001 C CNN "Digi-Key PN"
	1    1990 1950
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5EA1072B
P 5550 2150
F 0 "#PWR0915" H 5550 2000 50  0001 C CNN
...
U 1 1 5EA10BB4
P 4870 2030
F 0 "#PWR0911" H 4870 1880 50  0001 C CNN
...
U 1 1 5EA11070
P 4980 2770
F 0 "#PWR0913" H 4980 2620 50  0001 C CNN
...
U 1 1 5EA11877
P 2980 4270
F 0 "#PWR0908" H 2980 4120 50  0001 C CNN
...
U 1 1 5EA11EB0
P 3550 3650
F 0 "#PWR0910" H 3550 3500 50  0001 C CNN
...
U 1 1 5EA123C5
P 2870 3530
F 0 "#PWR0905" H 2870 3380 50  0001 C CNN
